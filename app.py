    ...
    with gr.Blocks(title="WitGym", css=APP_CSS, theme=_theme(), head=_GLOBAL_JS_SCRIPT_TAG) as demo:
        ...
        start_btn.click(
            ...
            js=(
                ...
                "  (function _poll(n){"
                "    setTimeout(function(){"
                "      var el = document.getElementById('wg-bubble-char-name');"
                "      if (el) {"
                "        wgUpdateCoachHeader && wgUpdateCoachHeader();"
                "        wgInitFlicker && wgInitFlicker();"
                "        wgInitRoasts && wgInitRoasts();"
                "      } else if (n > 0) { _poll(n - 1); }"
                "    }, 120);"
                "  })(40);"
                "  return [char, sess];"
                "}"
